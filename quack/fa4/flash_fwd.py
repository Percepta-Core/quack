...
from quack.fa4 import ampere_helpers as sm80_utils
from quack.fa4.cute_dsl_utils import assume_tensor_aligned
from quack.fa4 import utils
from quack.fa4.mask import AttentionMask
from quack.fa4.softmax import Softmax
from quack.fa4.seqlen_info import SeqlenInfoQK
from quack.fa4.block_info import BlockInfo
from quack.fa4.pack_gqa import PackGQA
from quack.fa4.named_barrier import NamedBarrierFwd
from quack.fa4.block_sparsity import BlockSparseTensors
from quack.fa4.tile_scheduler import SingleTileScheduler, SingleTileVarlenScheduler, TileSchedulerArguments
...
def __getattr__(name):
    if name == "FlashAttentionForwardSm90":
        from quack.fa4.flash_fwd_sm90 import FlashAttentionForwardSm90
